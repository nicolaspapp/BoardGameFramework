...
public class TileView extends StackPane {
    ...
    public TileView(TileEntity tile) {
        ...
        Rectangle bg = new Rectangle(tile.getWidth(), tile.getHeight(), Color.rgb(13, 222, 236));

        Rectangle bg2 = new Rectangle(tile.getWidth() * 0.8, tile.getHeight() * 0.8, Color.rgb(250, 250, 250, 0.25));
        bg2.setArcWidth(25);
        bg2.setArcHeight(25);
        ...
        tile.getComponent(TileModel.class).valueProperty().addListener((observable, oldValue, newValue) -> {
            animate(newValue);
        });
